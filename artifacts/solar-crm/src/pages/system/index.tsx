import { useGetSystemHealth, useListBackups, useCreateBackup, getGetSystemHealthQueryKey } from "@workspace/api-client-react";
...
export function System() {
  const { data: health, isLoading: healthLoading } = useGetSystemHealth({
    query: { refetchInterval: 30000, queryKey: getGetSystemHealthQueryKey() } // Refetch every 30s
  });
